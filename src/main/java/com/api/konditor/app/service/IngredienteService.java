...
public class IngredienteService {
  ...
  public PaginaResponse<IngredienteCardResponse> listar(
    ...
    log.debug(
        "[INGREDIENTE-SERVICE] Delegando listagem ao use case. workspaceId={}",
        usuario.workspaceId());
  ...
  public List<CategoriaIngredienteResponse> listarCategorias(UsuarioAutenticado usuario) {
    log.debug(
        "[INGREDIENTE-SERVICE] Delegando listagem de categorias ao use case. workspaceId={}",
        usuario.workspaceId());
  ...
  public IngredienteResponse criar(CriarIngredienteRequest request, UsuarioAutenticado usuario) {
    log.debug(
        "[INGREDIENTE-SERVICE] Delegando criação ao use case. workspaceId={}",
        usuario.workspaceId());
  ...
  public IngredienteResponse buscarPorId(UUID id, UsuarioAutenticado usuario) {
    log.debug(
        "[INGREDIENTE-SERVICE] Delegando busca por id={} ao use case. workspaceId={}",
        id,
        usuario.workspaceId());
  ...
  public IngredienteResponse atualizar(
    ...
    log.debug(
        "[INGREDIENTE-SERVICE] Delegando atualização ao use case. id={} workspaceId={}",
        id,
        usuario.workspaceId());

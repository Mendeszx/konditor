 ...
 * <p>Rotas:
 * <ul>
 *   <li>{@code POST /auth/google}  — troca Google ID Token por JWT + cookie de refresh</li>
 *   <li>{@code POST /auth/refresh} — renova o access token via cookie (sem Authorization)</li>
 *   <li>{@code POST /auth/logout}  — revoga todas as sessões e limpa o cookie</li>
 * </ul>
 */
@Slf4j
@RestController
...
public class AuthController {
    ...
    /**
     * Autentica o usuário com um Google ID Token.
     * Retorna o access token no body e o refresh token em cookie HttpOnly.
     */
    @PostMapping("/google")
     ...
     * O cookie é enviado automaticamente pelo browser — nenhum header adicional necessário.
     */
    @PostMapping("/refresh")
     ...
     * Revoga todos os refresh tokens e remove o cookie.
     */
    @PostMapping("/logout")

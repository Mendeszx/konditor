 ...
 *
 * <p>Contém os dados que o novo usuário informa durante o fluxo de onboarding:
 * o nome do workspace (confeitaria/doceria) e a moeda preferida.
 * O usuário já está autenticado via JWT — seus dados são extraídos do token.
 */
@Getter
@Setter
@NoArgsConstructor
...
public class OnboardingRequest {
    ...
    @Size(min = 3, max = 3, message = "A moeda deve ser um código ISO 4217 de 3 caracteres (ex: BRL, USD)")

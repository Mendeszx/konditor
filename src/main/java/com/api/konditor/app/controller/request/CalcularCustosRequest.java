 ...
 * <ul>
 *   <li>{@code custosFixosTipo = "percentual"} — percentual aplicado sobre o custo de ingredientes</li>
 *   <li>{@code custosFixosTipo = "fixo"}       — valor direto em reais (ex: R$ 200,00 de aluguel rateado)</li>
 * </ul>
 */
@Getter
@Setter
...
public class CalcularCustosRequest {
    ...
    /**
     * Valor da hora de trabalho do confeiteiro (ex: R$ 25,00/hora).
     * O custo de mão de obra para esta receita será:
     * {@code maoDeObraValorHora × (tempoPreparoMinutos / 60)}.
     */
    ...
    /**
     * Tempo de preparo da receita em minutos (aceita frações, ex: 90.5 para 90 min e 30 s).
     * Usado para calcular o custo de mão de obra proporcional:
     * {@code custoMaoDeObra = maoDeObraValorHora × (tempoPreparoMinutos / 60)}.
     * Exemplos: 90 para 1 h 30 min, 45 para 45 min, 120 para 2 h.
     */
    ...
    /**
     * Valor dos custos fixos. Interpretado como percentual ou valor absoluto
     * conforme {@link #custosFixosTipo}.
     */
     ...
     * <ul>
     *   <li>{@code "percentual"} — ex: 15 significa 15% do custo de ingredientes</li>
     *   <li>{@code "fixo"}       — ex: 200 significa R$ 200,00 fixos</li>
     * </ul>
     */
    ...
    /**
     * Margem de lucro desejada para o preço sugerido. Padrão: 30%.
     * Intervalo válido: [0, 99].
     */

 ...
 *
 * <p>Carrega todas as claims do token para que qualquer endpoint protegido tenha acesso imediato ao
 * contexto do tenant, sem consultas adicionais ao banco.
 *
...
public record UsuarioAutenticado(
    String id, String email, String name, String workspaceId, Role role, Plan plan) {}

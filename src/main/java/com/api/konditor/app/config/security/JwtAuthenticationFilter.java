 ...
 *
 * <p>Não realiza consulta ao banco — o principal é um {@link UsuarioAutenticado} montado
 * diretamente a partir das claims do token, incluindo o contexto do tenant (workspaceId, role e
 * plano).
 *
 * <p>Em caso de token inválido, malformado ou com claims ausentes, a cadeia é interrompida e a
 * resposta 401 é enviada imediatamente pelo {@link RestAuthenticationEntryPoint}.
 */
@Slf4j
@Component
  ...
  protected void doFilterInternal(
    ...
    try {
      ...
      if (SecurityContextHolder.getContext().getAuthentication() == null) {
        ...
        log.debug(
            "[SECURITY] JWT válido — id={} workspace={} rota={}",
            userId,
      ...
      log.warn(
          "[SECURITY] JWT rejeitado — rota={} motivo={}", request.getRequestURI(), e.getMessage());

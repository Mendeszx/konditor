 ...
 *
 * <p>Sem essa limpeza, a tabela {@code refresh_tokens} cresceria indefinidamente. Executa
 * diariamente às 03:00 UTC por padrão (configurável via {@code security.token-cleanup.cron}).
 */
@Slf4j
@Component

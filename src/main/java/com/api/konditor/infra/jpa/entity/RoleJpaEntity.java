 ...
 * <p>
 * Armazena os papéis disponíveis dentro de um workspace com suas permissões
 * granulares e nível hierárquico.
 */
@Entity
@Table(name = "roles")
@Getter
...
public class RoleJpaEntity {
    ...
    /**
     * Nível hierárquico: owner=100, admin=50, member=10.
     * Quanto maior, mais permissões possui.
     */

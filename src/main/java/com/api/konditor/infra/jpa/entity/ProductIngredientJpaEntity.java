 ...
 * <p>
 * Cada linha representa um ingrediente e sua quantidade usada na receita do produto.
 * O custo é derivado de {@code ingredient.costPerUnit * quantity} — não armazenado aqui.
 */
@Entity
@Table(

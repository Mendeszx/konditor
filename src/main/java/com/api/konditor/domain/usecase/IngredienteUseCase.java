...
public interface IngredienteUseCase {
  ...
  /**
   * Retorna a listagem paginada de ingredientes do workspace, com suporte a filtro opcional por
   * categoria.
   *
  ...
  /**
   * Retorna os detalhes completos de um ingrediente pelo ID, garantindo que ele pertence ao
  ...
  /**
   * Cria um novo ingrediente no workspace autenticado. Valida unicidade do nome e referências a
   * unidade e categoria.
   *
  ...
  /**
   * Atualiza todos os campos de um ingrediente existente no workspace. Valida unicidade do nome
   * (excluindo o próprio registro) e referências.
   *
